...
import { Text, View, ScrollView, TouchableOpacity, RefreshControl, ActivityIndicator, Image, ImageBackground, StyleSheet, useWindowDimensions, DimensionValue } from 'react-native';
